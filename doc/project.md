...
* MySQL数据访问地址`jdbc:mysql://139.159.213.28:3306/litemall`
...
以及`apis.js`中的`WxApiRoot`，即小商场服务根地址。
    ...
    // 云平台部署时使用
    // var WxApiRoot = 'http://139.159.213.28:8080/wx/';
    // 云平台上线时使用
...
spring:
  datasource:
    druid:
      url:  jdbc:mysql://139.159.213.28:3306/litemall?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC&allowPublicKeyRetrieval=true&verifyServerCertificate=false&useSSL=false
...
litemall:
  wx:
    app-id: wx81a06ee98a1178a0
    app-secret: 679ad816918e4b9466d2387a1da08b96
```
